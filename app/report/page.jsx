    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      {noRealData && (
        <div className="space-y-6">
          ...
          <ReportContainer>
            <ReportCard title="🧠 Samenvatting BTC" content="Bitcoin consolideert na een eerdere uitbraak. RSI neutraal. Volume lager dan gemiddeld." full />
      ...
      {!loading && report && (
        <ReportContainer>
          <ReportCard title="🧠 Samenvatting BTC" content={report.btc_summary} full />
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
