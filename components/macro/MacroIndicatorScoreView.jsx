...
export default function MacroIndicatorScoreView() {
  ...
  // 📡 Alle macro-indicatoren ophalen (eenmalig bij laden)
  useEffect(() => {
    ...
    fetchIndicators();
  }, []); // ✅ GEEN automatische toevoegingen hier
  ...
  // ➕ Toevoegen aan macro-data (alleen bij geldige selectie)
  const handleAdd = async () => {
    ...
    try {
      console.log(`📤 Voeg toe aan macro_analyse: ${selectedIndicator.name}`);
