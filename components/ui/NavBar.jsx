  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-3 shadow bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
      ...
      <div className="flex items-center gap-6">
        <Link href="/" prefetch={false} className="text-gray-700 dark:text-gray-300 hover:underline">
          Dashboard
        </Link>
        <Link href="/setups" prefetch={false} className="text-gray-700 dark:text-gray-300 hover:underline">
          Setups
        </Link>
        <Link href="/strategien" prefetch={false} className="text-gray-700 dark:text-gray-300 hover:underline">
          Strategieën
        </Link>
        <button
