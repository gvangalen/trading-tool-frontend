...
//
// =======================================================
// 📌 2) USER MARKET DATA — IDENTIEK AAN MACRO MODEL
// =======================================================
//
...
// ✔ User indicatoren returned via zelfde history endpoint
...
// ✔ Verwijderen (per gebruiker — LET OP: ID!)
export const marketIndicatorDelete = (indicatorId) =>
  fetchAuth(`/api/market_data/indicator/${indicatorId}`, {
    method: 'DELETE',
  });
