...
export const createStrategy = async (strategyData) => {
  ...
  return await fetchWithAuth(`/api/strategies`, {
    method: "POST",
...
export const fetchStrategies = async (symbol = '', timeframe = '', tag = '') => {
  const res = await fetchWithAuth(`/api/strategies/query`, {
    method: "POST",
...
export const updateStrategy = async (id, data) =>
  await fetchWithAuth(`/api/strategies/${id}`, {
    method: "PUT",
...
export const generateStrategy = async (setupId, overwrite = true) =>
  await fetchWithAuth(`/api/strategies/generate/${setupId}`, {
    method: "POST",
...
export const generateAllStrategies = async () =>
  await fetchWithAuth(`/api/strategies/generate_all`, {
    method: "POST",
  });
...
export const fetchStrategySummary = async () =>
  await fetchWithAuth(`/api/strategies/summary`, {
    method: "GET",
  });
...
export const fetchScoreMatrix = async () =>
  await fetchWithAuth(`/api/strategies/score_matrix`, {
    method: "GET",
  });
...
export const fetchStrategyExplanation = async (id) =>
  await fetchWithAuth(`/api/strategies/${id}/explanation`, {
    method: "GET",
  });
...
export const exportStrategiesCSV = async () =>
  await fetchWithAuth(`/api/strategies/export`, {
    method: "GET",
  });
...
export const fetchLastStrategy = async () => {
  const res = await fetchWithAuth(`/api/strategies/last`, { method: "GET" });
