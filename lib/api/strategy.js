...
//
// =========================================================
// 9. AI-UITLEG PER STRATEGIE (oud, indien nog gebruikt)
// =========================================================
...
// =========================================================
// 14. 🧠 AI-ANALYSE VAN STRATEGIEËN (USER-LEVEL)
// 👉 analyseert ALLE strategieën van de gebruiker
// 👉 slaat resultaat op in ai_category_insights (strategy)
// =========================================================
export const analyzeStrategy = async () =>
  await fetchAuth(`/api/strategies/analyze`, {
    method: 'POST',
  });
...
//
// =========================================================
// 15. 📊 OPGEHAALDE AI-ANALYSE (PERSISTENT)
// =========================================================
