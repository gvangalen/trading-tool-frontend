...
// 📊 Technische samenvattingen per periode (correcte routes!)
export const fetchTechnicalDataDay = () =>
  fetchWithRetry(`${API_BASE_URL}/api/technical_data/day`, 'GET');

export const fetchTechnicalDataWeek = () =>
  fetchWithRetry(`${API_BASE_URL}/api/technical_data/week`, 'GET');

export const fetchTechnicalDataMonth = () =>
  fetchWithRetry(`${API_BASE_URL}/api/technical_data/month`, 'GET');

export const fetchTechnicalDataQuarter = () =>
