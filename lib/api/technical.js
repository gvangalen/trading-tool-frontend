...
// 📥 1. Haal alle technische data op (laatste 20 of alle entries)
export const fetchTechnicalData = () =>
  fetchWithRetry(`${API_BASE_URL}/technical_data`, 'GET');

// ➕ 2. Voeg handmatig nieuwe technische data toe
export const addTechnicalAsset = (symbol, rsi, volume, ma_200, price, timeframe) =>
  fetchWithRetry(`${API_BASE_URL}/technical_data/add`, 'POST', {
    symbol,
    rsi,
    volume,
    ma_200,
...
export const testTechnicalAPI = () =>
  fetchWithRetry(`${API_BASE_URL}/technical_data/test`, 'GET');
